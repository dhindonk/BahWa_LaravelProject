...
<body class="bg-dark">
    ...
    <div class="container-fluid text-center" style="padding: 20px;">
        ...
        <div class="row mt-3">
            <div class="col g-2" style="margin: 15px;">
                <div class="card bg-dark" style="border: 0;">
                    <img src="{{ asset('/storage/posts/'.$post->image) }}" style=" height: 220px; width: 100%; object-fit: cover" class="card-img-top" alt="{{ $post->title }}">
                    <div class="card-body">
