    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Bahwa<sup>Admin</sup></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Fahdin</span>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        {{-- <img src="{{ asset('/storage/posts/'.$post->video) }}" class="rounded"
                                                            style="width: 150px"> --}}
                                                        <video controls src="{{ asset('/storage/posts/'.$post->video) }}" class="rounded"
                                                            style="width: 150px"></video>
                                                    </td>
                                                    <td>{{ $post->title }}</td>
                                                    <td>{!! $post->content !!}</td>
                                                    <td class="text-center">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Bahwa 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
